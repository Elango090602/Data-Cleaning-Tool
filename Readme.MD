...
3. OTP is sent through Gmail SMTP, Brevo, or Resend
4. User enters OTP
5. Backend validates the OTP and starts a secure session

### Google OAuth

1. User selects Google login
2. Google verifies the user account
3. Backend checks whether the account exists
4. User is redirected to the dashboard after successful authentication
